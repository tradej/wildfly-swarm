...
. Include the {Thorntail} BOM as described in xref:using-a-bom_{context}[]:
+
[source,xml]
----
<dependencyManagement>
  <dependencies>
include::../resources/pom/testing-in-container/pom.xml[tag=bom,indent=4]
  </dependencies>
</dependencyManagement>
----
...
----
<dependencies>
include::../resources/pom/testing-in-container/pom.xml[tag=arquillian,indent=2]
</dependencies>
----
...
[source,yml]
----
include::../resources/yml/testing-in-container/project-defaults.yml[]
----
...
[source,java]
----
include::../resources/java/testing-in-container/src/test/java/org/wildfly/swarm/howto/incontainer/InContainerTest.java[tag=classdef,indent=0]
----
...
[source,java]
----
include::../resources/java/testing-in-container/src/test/java/org/wildfly/swarm/howto/incontainer/InContainerTest.java[tag=prolog,indent=0]
----
...
[source,java]
----
include::../resources/java/testing-in-container/src/test/java/org/wildfly/swarm/howto/incontainer/InContainerTest.java[tag=package,indent=0]
----
...
[source,java]
----
include::../resources/java/testing-in-container/src/test/java/org/wildfly/swarm/howto/incontainer/InContainerTest.java[tag=arquillian-resource,indent=0]
----
...
[source,java]
----
include::../resources/java/testing-in-container/src/test/java/org/wildfly/swarm/howto/incontainer/InContainerTest.java[tag=test,indent=0]
----
--
