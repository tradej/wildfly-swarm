...
----
ifndef::product[]
include::../resources/pom/application-from-scratch/pom.xml[]
endif::[]
ifdef::product[]
include::../resources/pom/application-from-scratch/pom-product.xml[]
endif::[]
----
...
----
include::../resources/java/application-from-scratch/HelloWorldEndpoint.java[]
----
...
[source,java,options="nowrap"]
----
include::../resources/java/application-from-scratch/RestApplication.java[]
----
