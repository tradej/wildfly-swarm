...
ifndef::product[]
include::../modules/ref_thorntail-community-bom-types.adoc[leveloffset=+1]
endif::[]

ifdef::product[]
include::../modules/ref_thorntail-product-bom-types.adoc[leveloffset=+1]
endif::[]

include::../modules/proc_specifying-a-bom-in-your-application.adoc[leveloffset=+1]
