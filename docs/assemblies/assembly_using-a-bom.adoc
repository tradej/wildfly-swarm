...
ifndef::product[]
include::../reference/ref_thorntail-community-bom-types.adoc[leveloffset=+1]
endif::[]

ifdef::product[]
include::../reference/ref_thorntail-product-bom-types.adoc[leveloffset=+1]
endif::[]

include::../howto/proc_specifying-a-bom-in-your-application.adoc[leveloffset=+1]
